...
public class PressImageButton extends ImageButton {
    ...
    public void setUnpressedColor(int color) {
        ...
        setImageDrawable(PictureTool.setBitmapDrawableColor(getResources(), mUnpressedDrawable, color));
    }
    ...
    private void createPressedDrawable() {
        mPressedDrawable = PictureTool.setBitmapDrawableColor(getResources(), mUnpressedDrawable, mPressedColor);
    }
