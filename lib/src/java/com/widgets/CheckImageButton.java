...
import com.stardust.tool.PictureTool;
...
public class CheckImageButton extends ImageButton implements View.OnClickListener, View.OnTouchListener {
    ...
    public void setUncheckedColor(int color) {
        ...
        mUncheckedDrawable = PictureTool.setBitmapDrawableColor(getResources(), mUncheckedDrawable, mUncheckedColor);
    }
    ...
    private void createCheckDrawable() {
        mCheckedDrawable = PictureTool.setBitmapDrawableColor(getResources(), mUncheckedDrawable, mCheckedColor);
    }
