...
public class DatabaseTool {
    ...
    public static boolean dbCopyFromRaw(Context context, int id, String dbName, boolean deleteIfExists) {
        ...
        try {
            ...
            InputStream source = context.getResources().openRawResource(id);
